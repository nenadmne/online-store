...
import ProductDetails, {
  detailLoader,
} from "./Layouts/ProductDetails/ProductDetails";
import ProductProvider from "./Store/contextProvider";
import EditProductInformation, {
  editProductAction,
} from "./Layouts/EditProductInfo/EditProductInformation";
...
import Loggedin, {
  informationAction,
  informationLoader,
} from "./Layouts/LoggedIn/Loggedin";
import User, { userLoader } from "./Layouts/User/User";
import UserEdit, { editAction, editLoader } from "./Layouts/UserEdit/UserEdit";
...
import AdminOrders, {
  AdminOrdersLoader,
} from "./Layouts/AdminOrders/AdminOrders";
import {
  addProductAction,
  editProductLoader,
  deleteItemAction,
